...
export default function About() {
  ...
  const features = [
    { icon: '📚', text: t('about.features.item1') },
    { icon: '🧘', text: t('about.features.item2') },
    { icon: '📊', text: t('about.features.item3') },
    { icon: '🌐', text: t('about.features.item4') },
  ]
      ...
      <div className="space-y-12">
        ...
        <section className="opacity-0 animate-fade-in-up stagger-2">
          <div className="flex items-start gap-4 mb-4">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-light/30 to-primary/20 flex items-center justify-center shrink-0">
        ...
        <section className="opacity-0 animate-fade-in-up stagger-3">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-secondary-light/30 to-secondary/20 flex items-center justify-center shrink-0">
          ...
          <div className="grid gap-4 pl-16">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-start gap-4 p-4 bg-card rounded-2xl border border-border-light hover:border-primary/20 hover:shadow-soft transition-all duration-300"
              >
                <span className="text-2xl">{feature.icon}</span>
                <span className="text-text-secondary leading-relaxed pt-1">{feature.text}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="opacity-0 animate-fade-in-up stagger-4">
          <div className="p-8 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5 rounded-3xl border border-primary/10">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-accent-light/30 to-accent/20 flex items-center justify-center shrink-0">
